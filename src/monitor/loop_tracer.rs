...
use crate::monitor::{add_global, bundle_load_store_args, call_flush_on_exit, fix_stack, import_lib_func, LocalsTracker};
...
fn import_maps_lib(wasm: &mut Module) -> Maps {
    ...
    Maps {
        ...
        insert: import_lib_func(lib, "insert_i32booltuple_i32", &[I32, I32, I32, I32], &[], wasm),
